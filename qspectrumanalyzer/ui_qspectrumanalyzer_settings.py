...
class Ui_QSpectrumAnalyzerSettings(object):
    def setupUi(self, QSpectrumAnalyzerSettings):
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.waterfallHistorySizeSpinBox)
        self.label_5 = QtWidgets.QLabel(QSpectrumAnalyzerSettings)
        self.label_5.setObjectName("label_5")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_5)
        self.deviceIndexSpinBox = QtWidgets.QSpinBox(QSpectrumAnalyzerSettings)
        self.deviceIndexSpinBox.setMinimum(0)
        self.deviceIndexSpinBox.setMaximum(99)
        self.deviceIndexSpinBox.setProperty("value", 0)
        self.deviceIndexSpinBox.setObjectName("deviceIndexSpinBox")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.deviceIndexSpinBox)
    ...
    def retranslateUi(self, QSpectrumAnalyzerSettings):
        ...
        self.backendComboBox.setItemText(0, _translate("QSpectrumAnalyzerSettings", "rtl_power"))
        self.backendComboBox.setItemText(1, _translate("QSpectrumAnalyzerSettings", "rtl_power_fftw"))
        self.backendComboBox.setItemText(2, _translate("QSpectrumAnalyzerSettings", "hackrf_sweep"))
        self.label.setText(_translate("QSpectrumAnalyzerSettings", "E&xecutable:"))
        self.executableEdit.setText(_translate("QSpectrumAnalyzerSettings", "rtl_power"))
        ...
        self.label_5.setText(_translate("QSpectrumAnalyzerSettings", "&Device index:"))
